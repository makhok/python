...
class My_wardrobe(Wardrobe):
    ...
    @property
    def calc_c(self):
        return f'Расход ткани для пальто: {self.size / 6.5 + 0.5}'

    @property
    def calc_s(self):
        return f'Расход ткани для костюма: {2 * self.height + 0.3}'


my_coat = My_wardrobe(50, 1.75)
print(f'Размер пальто: {my_coat.size}\nРост пальто: {my_coat.height}')
print(my_coat.calc_c)
print(my_coat.calc_s)
